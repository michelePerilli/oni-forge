...
struct OnccImpactValidationResult {
    std::string onccStem;                         ///< The filename stem of the validated ONCC.
    std::vector<std::string> unregisteredImpacts; ///< List of impact names found in TRAMs but missing from the ONCC particle list.
};
